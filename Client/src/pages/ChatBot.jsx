...
import { Send, X, Calendar, Clock, MapPin, Stethoscope, AlertCircle } from 'lucide-react';
    ...
    return (
      <div className="space-y-4 bg-blue-50 p-4 rounded-lg">
        {precautions.initial_assessment && (
          <div className="border-b border-blue-200 pb-2">
            ...
            <p className="text-sm text-blue-600">
              Severity: <span className="font-medium">{precautions.initial_assessment.severity}</span>
            </p>
        ...
        {precautions.precautions && (
          <div>
            <p className="font-semibold text-blue-800 mb-2">Recommended Precautions:</p>
            <div className="space-y-2">
              {precautions.precautions.map((item, index) => (
                <div key={index} className="bg-white p-2 rounded border border-blue-200">
                  <p className="text-sm font-medium text-blue-700">{item.category}</p>
                    ...
                    <div key={doctor.doctorId} 
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-1 text-blue-500">
                          <Calendar size={16} />
                          <span className="text-sm">{doctor.experience}y exp</span>
                        </div>
                      </div>
                      ...
                      <button 
                        ...
                        onClick={() => console.log('Book appointment:', doctor)}
                      >
                        <Calendar size={16} />
